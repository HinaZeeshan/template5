    ...
    <div className="relative bg-[#01b7dc] w-full h-screen flex items-center justify-center md:h-[600px]">
      <div className="container  mx-auto  flex flex-col md:flex-row items-center justify-center">
        ...
        <div className=" flex  flex-col justify-center items-center md:text-left max-w-lg">
          <p className="text-white uppercase tracking-widest text-sm mb-2">Summer 2020</p>
          <h1 className="text-4xl md:text-6xl hover:scale-105 transition-transform duration-500 ease-in-out  font-bold text-white mb-4">New Collection</h1>
